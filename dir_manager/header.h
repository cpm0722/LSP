...
// 명령어 종류 판단하는 열거형
enum eCmdCase { NONE, DELETE, SIZE, RECOVER, TREE, EXIT, HELP };
typedef enum eCmdCase CmdCase;

// 파일 변경 상태 판단하는 열거형
enum eFileStatus { CREATED, DELETED, MODIFIED };
typedef enum eFileStatus FileStatus;
